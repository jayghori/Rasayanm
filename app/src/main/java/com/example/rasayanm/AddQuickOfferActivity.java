...
public class AddQuickOfferActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_quick_offer);
        ...
        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(AddQuickOfferActivity.this);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!title.trim().isEmpty() && !stock.trim().isEmpty() && !discription.trim().isEmpty() && !price.trim().isEmpty()) {
                    ...
                    FirebaseStorage.getInstance().getReference().child("QuickOffer").child(id).putFile(dataFile.getData()).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        @Override
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    QuickOffer quickOffer = new QuickOffer(id, title, stock, discription, locality, countryName, price, uri.toString(), stockUnit, priceUnit, gradeUnit);

                                    DocumentReference documentReference = firebaseFirestore.collection("QuickOffer").document(title);
                                    documentReference.set(quickOffer).addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {
                                            Intent intent = new Intent(AddQuickOfferActivity.this, QuickOfferActivity.class);
                    ...
                    Toast.makeText(AddQuickOfferActivity.this, "Please Field Data", Toast.LENGTH_SHORT).show();
        ...
        if (ActivityCompat.checkSelfPermission(AddQuickOfferActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) ==
                PackageManager.PERMISSION_GRANTED) {
            getLocation();
        } else {
            ActivityCompat.requestPermissions(AddQuickOfferActivity.this, new String[]{
                    Manifest.permission.ACCESS_FINE_LOCATION}, 44);
        }

        ArrayAdapter arrayAdapter = new ArrayAdapter(AddQuickOfferActivity.this, R.layout.support_simple_spinner_dropdown_item, grade);
        arrayAdapter.setDropDownViewResource(R.layout.support_simple_spinner_dropdown_item);
        spinGrade.setAdapter(arrayAdapter);

        ArrayAdapter arrayAdapter1 = new ArrayAdapter(AddQuickOfferActivity.this, R.layout.support_simple_spinner_dropdown_item, quality);
        arrayAdapter.setDropDownViewResource(R.layout.support_simple_spinner_dropdown_item);
        spinQuality.setAdapter(arrayAdapter1);

        ArrayAdapter arrayAdapter2 = new ArrayAdapter(AddQuickOfferActivity.this, R.layout.support_simple_spinner_dropdown_item, quality1);
        arrayAdapter.setDropDownViewResource(R.layout.support_simple_spinner_dropdown_item);
    ...
    private void getLocation() {
        ...
        fusedLocationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
            ...
            public void onComplete(@NonNull Task<Location> task) {
                ...
                if (location != null) {
                    Geocoder geocoder = new Geocoder(AddQuickOfferActivity.this, Locale.getDefault());
                    try {
